...
大题（5，6个，挺多的）每个5分左右，CPU调度、死锁、磁盘存储、页表、文件系统、PV等

题目有中文有英文（英文基本上都能看懂），答题用中英文均可



复习可以参考：

[xjtucs-homework--2-2.5/操作系统 at main · gymdarius/xjtucs-homework--2-2.5](https://github.com/gymdarius/xjtucs-homework--2-2.5/tree/main/操作系统)
